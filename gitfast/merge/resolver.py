import sys
from gitfast.utils.git import run_git, is_git_repo, stage_file, current_branch
from gitfast.utils.colors import Printer
from gitfast.merge.detector import scan_repo, display_conflicts, get_merge_state
from gitfast.merge.parser import parse_conflicts, write_resolved
from gitfast.merge.backup import create_backup, restore_backup
from gitfast.merge.strategies import Strategy, apply_strategy_to_all
from gitfast.merge.interactive import run_interactive
