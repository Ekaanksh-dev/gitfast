...
def test_expiry_none():
    from gitshorts.token.expiry import days_until_expiry
...
def test_should_warn_false():
    from gitshorts.token.expiry import should_warn
...
def test_format_expiry_none():
    from gitshorts.token.expiry import format_expiry_display
...
def test_parse_expiry_valid():
    from gitshorts.token.expiry import parse_expiry
...
def test_netrc_save_load_delete():
    ...
    import gitshorts.token.storage as s
